...
enum class TopLevelDestination(
    ...
    companion object {
        ...
        fun NavDestination.isTopLevel(): Boolean {
            return entries.any {
                matchesRoute(it.route)
            }
        }
    }
}

// Custom extension to check if a destination matches a given route
private fun NavDestination.matchesRoute(route: Route): Boolean {
    return this.route == route::class.simpleName
}
...
private fun calculateNavigationLayoutType(
    ...
    return when {
        ...
        destination.matchesRoute(Route.Camera(chatId = 0)) -> NavigationSuiteType.None
        ...
        navigationSuiteItems = {
            TopLevelDestination.entries.forEach {
                ...
                item(
                    ...
                    onClick = {
                        if (!isSelected) {
                            navController.navigate(it.route::class.simpleName!!) {
